...
var AsyncControllableInput = /** @class */ (function (_super) {
    ...
    AsyncControllableInput.prototype.render = function () {
        ...
        return (React.createElement("input", tslib_1.__assign({}, restProps, { ref: inputRef, value: isComposing ? localValue : externalValue, onCompositionStart: this.handleCompositionStart, onCompositionEnd: this.handleCompositionEnd, onChange: this.handleChange })));
    };
