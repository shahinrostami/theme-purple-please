...
var Tree = /** @class */ (function (_super) {
    ...
    Tree.prototype.render = function () {
        return (React.createElement("div", { className: classnames_1.default(Classes.TREE, Classes.FIXED_POSITIONING_CONTAINING_BLOCK, this.props.className) }, this.renderNodes(this.props.contents, [], Classes.TREE_ROOT)));
    };
    /**
