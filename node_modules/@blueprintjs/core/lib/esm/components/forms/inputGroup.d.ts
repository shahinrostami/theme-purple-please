...
import { HTMLInputProps, IControlledProps, IControlledProps2, IIntentProps, IProps, MaybeElement } from "../../common/props";
...
export interface IInputGroupProps2 extends Omit<HTMLInputProps, keyof IControlledProps2>, IControlledProps2, IIntentProps, IProps {
    /**
     * Set this to `true` if you will be controlling the `value` of this input with asynchronous updates.
     * These may occur if you do not immediately call setState in a parent component with the value from
     * the `onChange` handler, or if working with certain libraries like __redux-form__.
...
export declare class InputGroup extends AbstractPureComponent2<IInputGroupProps2, IInputGroupState> {
    ...
    componentDidUpdate(prevProps: IInputGroupProps2): void;
    protected validateProps(props: IInputGroupProps2): void;
