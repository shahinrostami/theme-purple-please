...
var Popover = /** @class */ (function (_super) {
    ...
    function Popover() {
        ...
        _this.renderTarget = function (referenceProps) {
            var _a = _this.props, fill = _a.fill, openOnTargetFocus = _a.openOnTargetFocus, targetClassName = _a.targetClassName, _b = _a.targetProps, targetProps = _b === void 0 ? {} : _b;
            var isOpen = _this.state.isOpen;
            var isHoverInteractionKind = _this.isHoverInteractionKind();
            var TagName = _this.props.targetTagName;
            if (fill) {
                TagName = "div";
            }
    ...
    Popover.prototype.render = function () {
        ...
        var _a = this.props, className = _a.className, disabled = _a.disabled, fill = _a.fill;
        ...
        var wrapperClasses = classNames(Classes.POPOVER_WRAPPER, className, (_b = {},
            _b[Classes.FILL] = fill,
            _b));
        return (React.createElement(Manager, null,
            React.createElement(WrapperTagName, { className: wrapperClasses },
