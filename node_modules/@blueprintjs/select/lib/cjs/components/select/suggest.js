...
var Suggest = /** @class */ (function (_super) {
    ...
    Suggest.prototype.componentDidUpdate = function (_prevProps, prevState) {
        ...
        if (this.state.isOpen === false && prevState.isOpen === true) {
            ...
            /* eslint-disable-next-line deprecation/deprecation */
            var timeout = (_b = (_a = this.props.popoverProps) === null || _a === void 0 ? void 0 : _a.transitionDuration) !== null && _b !== void 0 ? _b : core_1.Popover.defaultProps.transitionDuration;
